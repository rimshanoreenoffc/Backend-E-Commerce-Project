...
const factoryProductReviewSchema = new mongoose.Schema({
  ...
  factoryProductRating: { type: Number, required: true, min: 1, max: 5 },
}, { timestamps: true });

const FactoryProductReview = mongoose.model("FactoryProductReview", factoryProductReviewSchema);
export default FactoryProductReview;
